...
from ranker import Ranker, WordCountCosineSimilarity, DirichletLM, BM25, PivotedNormalization, TF_IDF, LengthNormalizedScorer
...
class TestWordCountCosineSimilarity(unittest.TestCase):
    def setUp(self) -> None:
        ...
        self.index = Indexer.create_index(
            IndexType.PositionalIndex, 'tests/dataset_1.jsonl', self.preprocessor, self.stopwords, 1)
